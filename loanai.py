...
# 3. PDF Generator (Fixed for Bytearray & Encoding errors)
def generate_pdf(data_dict):
    ...
    pdf.cell(0, 10, text="Generated by AI Credit Risk System. Confidential Document.", ln=True)
    ...
    if model is None:
        ...
        if dti_ratio > 0.60 or credit_score < 450:
            ...
            if risk_prob > 35:
                ...
                st.info("The application has been flagged due to high volatility.")
            else:
